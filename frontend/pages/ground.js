    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex flex-col font-inter text-[#18181B] relative overflow-hidden">
      ...
      <header className="bg-white/80 backdrop-blur-md border-b border-gray-200 px-6 py-3 flex justify-between items-center shadow-sm sticky top-0 z-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition shadow-sm">
            <Navigation size={14} className="text-blue-500" /> Update
          </button>
        </div>
      </header>
      ...
      <div className="p-6 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-[1400px] mx-auto w-full h-[calc(100vh-70px)]">
          ...
          <div className="p-6 flex-1 flex flex-col overflow-y-auto">
            <div className="flex justify-between items-start mb-6 mt-2">
              <div>
                ...
                <h2 className="text-3xl font-bold text-gray-900">Victim #3</h2>
                <p className="text-sm text-gray-500 mt-1 font-medium flex items-center gap-1.5">
                  <AlertTriangle size={14} className="text-yellow-500" /> Condition: Unknown
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-wider block mb-2">Coordinates</span>
                <p className="text-sm font-semibold text-gray-800">34.0522° N</p>
                <p className="text-sm font-semibold text-gray-800">-118.2437° W</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
            ...
            <div className="mb-8">
              ...
              <div className="bg-white border border-gray-200 rounded-xl divide-y divide-gray-100 shadow-sm">
                <div className="p-3 flex items-center justify-between">
                  ...
                  <span className="text-sm font-bold text-gray-900">Heavy Rain, 18°C</span>
                </div>
                <div className="p-3 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-orange-600">Mudslide Risk</span>
                </div>
              </div>
            </div>
              ...
              {!arrived ? (
                ...
                <div className="space-y-4 animate-fade-in bg-gray-50 p-4 rounded-xl border border-gray-100">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button disabled className="bg-white flex flex-col items-center justify-center py-5 gap-3 border-2 border-gray-100 rounded-xl opacity-50 cursor-not-allowed">
                      <div className="w-12 h-12 rounded-full bg-red-50 text-red-400 flex items-center justify-center">
                        <Hospital size={24} />
                      </div>
                      <span className="text-sm font-bold text-gray-400">Hospital</span>
                    </button>
                    <button disabled className="bg-white flex flex-col items-center justify-center py-5 gap-3 border-2 border-gray-100 rounded-xl opacity-50 cursor-not-allowed">
                      <div className="w-12 h-12 rounded-full bg-green-50 text-green-400 flex items-center justify-center">
                        <Tent size={24} />
                      </div>
                      <span className="text-sm font-bold text-gray-400">Base Camp</span>
                    </button>
                  </div>
                </div>
              )}
        ...
        <div className="lg:col-span-8 relative bg-white rounded-2xl shadow-lg shadow-blue-100 border border-blue-100/50 overflow-hidden h-full group">
          ...
          <div className="absolute top-[calc(35%+120px)] left-[calc(25%+350px)] text-red-500 flex flex-col items-center animate-bounce">
            <div className="bg-white/90 px-2 py-1 rounded text-[10px] font-bold text-red-600 shadow-sm mb-1">Victim #3</div>
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-white/50 px-6 py-3 flex items-center gap-6 text-sm font-bold w-max">
            ...
            <div className="flex items-center gap-3">
              <div>
                ...
                <div className="text-gray-900 text-lg">1.4 km</div>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <button onClick={() => submitFeedback('hospital')} className="w-full bg-white border-2 border-gray-100 rounded-xl p-4 flex items-center justify-between text-left hover:border-red-400 hover:bg-red-50 hover:shadow-md transition group shadow-sm">
                    <div className="flex gap-4 items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-500 mt-0.5 font-medium">Critical condition, needs ER.</div>
                      </div>
                    </div>
