...
export default function HospitalDashboard() {
  ...
  const incomingPatients = [
    { id: '#PT-4829', condition: 'Blunt trauma, suspected internal bleeding', eta: '2 mins', unit: 'Medic Unit 04 (Officer JD)', status: 'CRITICAL', statusColor: 'bg-red-50 text-red-600 border border-red-100' },
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl p-6 text-white flex justify-between items-center mb-8 shadow-xl shadow-blue-500/30 animate-slide-up relative overflow-hidden">
              ...
              <div className="flex items-center gap-5 relative z-10">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-sm mt-1 font-medium">Mass casualty incident in Sector 7. Immediate bed allocation required.</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-4 gap-6 mb-8">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-xl shadow-gray-200/50 col-span-1 relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-5 mt-2">
                ...
                <span className="bg-red-50 text-red-600 text-[10px] font-bold px-2 py-1 rounded border border-red-100 uppercase tracking-wider">Severity: High</span>
              </div>
              <p className="text-[10px] text-gray-400 uppercase tracking-wider font-bold mb-1">Event Type</p>
              <h2 className="text-2xl font-bold text-gray-900 mb-4 tracking-tight">Flash Flood</h2>
              <p className="text-[10px] text-gray-400 uppercase tracking-wider font-bold mb-1">Primary Zone</p>
              <h3 className="text-sm font-bold text-gray-800">Sector 7 - Lower Basin</h3>
              <div className="mt-6 pt-4 border-t border-gray-100 text-xs font-medium text-gray-400 flex items-center gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-gray-400"></div> Declared 42 mins ago
              </div>
            </div>
